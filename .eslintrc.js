...
module.exports = {
  ...
  rules: {
    ...
    'wrap-iife': [
      ...
      {
        functionPrototypeMethods: true // 使用 .call 和 .apply 调用时，强制要求包裹函数表达式
      }
    ],
    ...
    'lines-around-comment': [
      2, // 要求在块级注释之前有一空行
      {
        ...
        allowObjectStart: false, // 禁止注释出现在对象字面量的开始位置
    ...
    // 强制模板字符串中空格的使用
    'template-curly-spacing': 2, // 默认：禁止花括号内出现空格
    ...
    'vue/valid-v-else-if': 0, // iView 的 Col 等元素无法通过此规则，故关闭
    'vue/valid-v-else': 0, // iView 的 Col 等元素无法通过此规则，故关闭
    'vue/no-parsing-error': [
      2,
      {
        'x-invalid-end-tag': false // iView 的 Col 等元素无法通过此规则，故关闭
      }
    ],
    // 要求或禁止在标签的右括号之前换行
